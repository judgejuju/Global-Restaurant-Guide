...
const INITIAL_DATA = {
  ...
  "Cannes": [
    ...
    v("Baoli Beach","Asian-French Fusion","Port Canto — Chef Rémi Solaz's Asian-inspired cuisine, Cloud Nine rooftop for sunset cocktails, transforms into Cannes' most electric nightclub by midnight, essential festival circuit destination, open March to October",4.6,f(false,false,true,false,true,true,false,false),"https://baolicannes.com",43.5436,7.0316),
    v("La Petite Maison Cannes","French Provençal","Palm Beach — Riviera classic by Nicole Rubi, truffle scrambled eggs, pissaladière, Cap d'Antibes views, the Nice institution that launched a global empire from London to Dubai, everyone treated like a film star",4.7,f(false,false,true,false,true,false,false,false),"https://lpminternational.com/cannes",43.539,7.043),
    v("Zuma Cannes","Japanese Robatayaki","Palm Beach — opened May 2024, the global brand's most glamorous Riviera outpost, massive terrace over the Côte d'Azur, live DJs, sushi and robata tableside theatre, the hottest Japanese restaurant on the French Riviera",4.7,f(false,true,true,false,true,true,false,false),"https://zumarestaurant.com/cannes",43.539,7.043,"sushi"),
    ...
    v("Mauro Colagreco Beach Restaurant","Mediterranean Beach","The three-star chef's casual beach concept, sustainable seafood and Riviera flavors at the shore",4.7,f(false,true,true,false,true,false,true,false),"https://mirazur.fr",43.5476,7.0218),
    ...
    v("L'Oasis","French Riviera","Historical La Napoule restaurant, lobster and sea views, 15 min from Cannes",4.6,f(false,false,false,true,false,false,false,true),"https://oasis-raimbault.com",43.5158,6.9562),
