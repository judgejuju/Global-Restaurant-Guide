...
const INITIAL_DATA = {
  ...
  "Miami": [
    ...
    v("Vice City Bean","Specialty Coffee","Coconut Grove / Coral Gables — Miami institution, expertly sourced beans, relaxed neighborhood café feel, excellent choice for a Coral Gables meeting",4.6,f(false,false,false,true,false,false,false,true),"https://vicecitybean.com",25.7631,-80.1918,"coffee"),
  ...
  "Las Vegas": [
    ...
    v("Guy Savoy","French","Caesars Palace — #1 Las Vegas restaurant in the 2026 La Liste global guide, artichoke and black truffle soup is mandatory, towering fine dining",4.9,f(true,false,false,true,true,false,true,true),"https://caesarspalace.com/restaurants/guy-savoy",36.116,-115.174),
  ...
  "Chicago": [
    ...
    // ── Coffee & Cafés ───────────────────────────────────────────────────
    v("Intelligentsia Coffee","Specialty Roaster","Millennium Park / Wicker Park — original pioneer of direct-trade specialty coffee, pour-overs and espresso of exceptional quality, beautiful light-filled flagship, ideal for a polished business coffee",4.7,f(false,false,false,true,false,false,false,true),"https://intelligentsiacoffee.com",33.9955,-118.4712,"coffee"),
    ...
    v("Café Integral","Nicaraguan Coffee","River North — all beans from Nicaragua, owner personally knows the farmers, distinct terroir-driven flavor unlike anything else, intimate and stylish",4.6,f(false,false,true,false,false,false,false,true),"https://cafeintegral.com",41.896,-87.631,"coffee"),
  ...
  "Scottsdale": [
    ...
    v("Giant Coffee","Design-Forward Café","Downtown Phoenix / Scottsdale — stunning industrial space, excellent espresso program, beloved by the creative professional community",4.6,f(false,false,true,false,false,false,false,true),"https://giantcoffee.com",33.4484,-112.074,"coffee"),
  ...
  "Napa": [
    ...
    v("Boon Fly Café","American Diner","Carneros Inn's beloved roadside café, outstanding breakfast and brunch",4.5,f(false,false,false,true,false,false,false,false),"https://boonflycafe.com",38.2445,-122.3027),
  ...
  "Healdsburg": [
    ...
    v("Willi's Seafood & Raw Bar","Seafood & Sushi","Healdsburg seafood and sushi, lively patio, excellent fish",4.5,f(false,false,true,false,false,false,false,false,false,true),"https://willisseafood.net",38.611,-122.8748,"sushi"),
  ...
  "Menlo Park": [
    ...
    v("Selby's","American Fine Dining","3001 El Camino Real, Redwood City — Michelin Star, sister to Village Pub, old Hollywood glamour with 75 pieces of original art, Beef Wellington, Dover sole meunière, 20,000-bottle wine list, prix fixe $78pp, tableside martini cart, the Peninsula's most opulent special-occasion restaurant",4.6,f(true,false,false,true,true,false,true,true),"https://selbysrestaurant.com",37.4807,-122.205),
    ...
    v("Rossotti's Alpine Inn","Beer Garden","3915 Alpine Rd — historic Portola Valley beer garden since 1852, casual outdoor tables, delicious food and great drinks, fun outdoor atmosphere, local institution",4.6,f(false,false,false,true,false,false,false,false),"https://alpineinn.com",37.372,-122.22,"bar"),
    v("Parkside Grille","Californian","884 Portola Rd, Portola Valley — fantastic ambiance, food execution and service, neighborhood gem tucked in the hills",4.6,f(false,false,false,true,false,false,false,true),"https://parksidegrille.com",37.375,-122.222),
    v("Portola Bistro","Italian","3130 Alpine Rd, Portola Valley — great atmosphere, delicious food, super friendly staff in a charming bistro setting",4.3,f(false,false,false,true,false,false,false,false),"https://portolabistro.com",37.372,-122.22),
  ...
  "Santa Monica": [
    ...
    v("Intelligentsia Coffee","Specialty Roaster","Silver Lake — Chicago's acclaimed roaster brought west, beautiful Sunset Junction café, precise espresso, great for a Silver Lake or Echo Park business coffee",4.7,f(false,false,true,false,false,false,false,true),"https://intelligentsiacoffee.com",33.9955,-118.4712,"coffee"),
  ],
  ...
  "Venice CA": [
    ...
    v("Intelligentsia Coffee","Specialty Roaster","Abbot Kinney Blvd — Chicago's acclaimed roaster came west, precise espresso, beautiful Venice flagship café with outdoor patio, great for a meeting on one of LA's coolest streets",4.7,f(false,false,true,false,false,false,false,true),"https://intelligentsiacoffee.com",33.9955,-118.4712,"coffee"),
  ...
  "Fort Lauderdale": [
    ...
    v("The Boatyard","Seafood","Waterfront seafood, yachts docking tableside",4.5,f(false,false,false,true,false,true,false,false),"https://boatyardrestaurant.com",26.0998,-80.114),
    v("Kaluz Restaurant","American","Intracoastal waterway dining, spectacular sunsets",4.5,f(false,false,true,false,false,false,false,true),"https://kaluzrestaurant.com",26.0938,-80.136),
  ...
  "Barcelona": [
    ...
    v("Shunka","Japanese","Koy Shunka's casual sibling, outstanding quality",4.6,f(false,false,false,true,false,false,true,false,false,true),"https://koyshunka.com/shunka",41.3841,2.1718,2.1758,"sushi"),
    v("Nobu Barcelona","Japanese-Peruvian","Celebrity sushi at Nobu's Barcelona outpost",4.5,f(false,false,true,false,true,false,false,false,false,true),"https://noburestaurants.com/barcelona",41.395,2.1638,"sushi"),
  
    // ── Coffee & Cafés ───────────────────────────────────────────────────
    v("Nomad Coffee","Specialty Roaster","El Born — Barcelona's most acclaimed specialty roaster, exceptional single-origin espresso, the café that put Barcelona on the specialty coffee map",4.8,f(false,false,true,false,false,false,false,true),"https://nomadcoffee.es",41.3841,2.1848,2.1786,"coffee"),
    v("Satan's Coffee Corner","Specialty Coffee","Gothic Quarter — beloved and brilliantly named hidden gem, exceptional espresso, tiny and quirky, a cult-favorite Barcelona experience",4.7,f(false,true,true,false,false,false,false,false),"https://satanscoffee.com",41.3818,2.1748,2.1734,"coffee"),
    v("Cafés El Magnífico","Specialty Roaster","El Born — roasting in Barcelona since 1919, exceptional house blends, beautiful historic shop, espresso made with decades of craft",4.7,f(false,false,false,true,false,false,false,false),"https://cafeselmagnific.com",41.3841,2.1848,2.1786,"coffee"),
    v("Federal Café","Australian Café","Sant Antoni — Australian brunch-café culture, excellent flat whites, avocado toast, beautiful space, great for a professional breakfast meeting",4.6,f(false,false,true,false,false,false,false,true),"https://federalcafe.es",41.3784,2.1608,2.1654,"coffee"),
    v("Syra Coffee","Specialty Café","Eixample — Barcelona specialty roaster and café, beautiful Eixample location, excellent for a business coffee in the upscale shopping district",4.6,f(false,false,true,false,false,false,false,true),"https://syracoffee.com",41.3877,2.1538,2.1686,"coffee"),
  ],

  "Cannes": [
    v("La Palme d'Or","French Mediterranean","1 Michelin Star — Hotel Martinez's legendary restaurant, host of the annual Cannes Jury Dinner, Chef Jean Imbert's cinematically immersive room designed like a vintage boat, menu styled as a film script, panoramic Croisette bay terrace",4.9,f(true,false,true,false,true,false,true,true),"https://hotel-martinez.hyatt.com",43.551,7.0199),
    v("La Villa Archange – Bastide Bruno Oger","Provençal French","2 Michelin Stars just outside Cannes — 18th-century Provençal house with century-old trees, Chef Bruno Oger's imaginative refined Mediterranean cuisine with local produce, Cannes' most prestigious Michelin destination, dinner for 2 around €1,000",4.9,f(true,false,false,true,false,false,true,true),"https://brunoger.com",43.5785,7.0033),
    v("Le Fouquet's at Hôtel Barrière Le Majestic","French Brasserie","Michelin-starred Chef Pierre Gagnaire on the Croisette — legendary terre et mer tartare, Caspian Oscietra caviar, whole sole Meunière, Harcourt Studio portrait gallery, 125 years of history, timeless film festival power meeting point",4.7,f(false,false,true,false,true,false,true,false),"https://hotelsbarriere.com/en/cannes/le-majestic/restaurants-and-bars/le-fouquets.html",43.5504,7.0108),
    v("La Môme","French Riviera Bistro","Steps from the Croisette — La Dolce Vita spirit, Slim Aarons photography, crudo towers, egg yolk ravioli, snacked octopus, wagyu tomahawk, the festival season celebrity magnet from brunch to late night",4.7,f(false,true,true,false,true,false,false,false),"https://lamome-cannes.com",43.5508,7.0174),
    v("Rüya at Carlton Cannes","Turkish Anatolian","Inside the iconic Carlton Cannes — only Anatolian restaurant on the Croisette, seven regions of Turkey in shared plates, charcoal-grilled King prawns, 24-hour Wagyu brisket, wood-fired pide, a genuine break from typical Riviera fare",4.7,f(false,true,true,false,true,false,false,false),"https://ruyarestaurant.co.uk/cannes",43.5512,7.0155),
    v("La Guérite","Mediterranean Beach Club","Accessible only by boat to Île Sainte-Marguerite — Cannes' most glamorous lunch, Greek-inspired cuisine by Chef Yiannis Kioroglou, crystalline water setting, the ultimate film festival celebrity hideaway",4.8,f(false,false,true,false,true,false,true,false),"https://laguerie.com",43.5197,7.0432),
    v("Baoli Beach","Asian-French Fusion","Port Canto — Chef Rémi Solaz's Asian-inspired cuisine, Cloud Nine rooftop for sunset cocktails, transforms into Cannes' most electric nightclub by midnight, essential festival circuit destination, open March to October",4.6,f(false,false,true,false,true,true,false,false),"https://baolicannes.com",43.5455,7.0313),
    v("La Petite Maison Cannes","French Provençal","Palm Beach — Riviera classic by Nicole Rubi, truffle scrambled eggs, pissaladière, Cap d'Antibes views, the Nice institution that launched a global empire from London to Dubai, everyone treated like a film star",4.7,f(false,false,true,false,true,false,false,false),"https://lpminternational.com/cannes",43.5415,7.0468),
    v("Zuma Cannes","Japanese Robatayaki","Palm Beach — opened May 2024, the global brand's most glamorous Riviera outpost, massive terrace over the Côte d'Azur, live DJs, sushi and robata tableside theatre, the hottest Japanese restaurant on the French Riviera",4.7,f(false,true,true,false,true,true,false,false),"https://zumarestaurant.com/cannes",43.5415,7.0468,"sushi"),
    v("La Plage du Martinez","Mediterranean Beach","Hotel Martinez private beach — Chef Jean Imbert's relaxed seafront restaurant, Mediterranean fare, sunbed service, the Croisette's most coveted lunch reservation during film festival week",4.7,f(false,false,true,false,true,false,false,false),"https://hotel-martinez.hyatt.com",43.551,7.0199),
    v("Anna Cannes","Modern Greek","Boulevard de la Croisette — Athenian-born Chef Yiannis Kioroglou, terrazzo floors evoking beach pebbles, blue-and-white ceiling, grilled octopus, fresh mezze, vibrant nighttime energy, the Croisette's most exciting Greek import",4.6,f(false,true,true,false,true,false,false,false),"https://anna-restaurant.fr",43.551,7.0155),
    v("Salama","Moroccan Mediterranean","Rue Florian — sibling to the legendary Saint-Tropez Salama, spiced pastilla, harira, inventive cocktails, candlelit and dramatic, a favourite celebrity hideaway off the Croisette",4.6,f(false,false,true,false,true,false,false,false),"https://salamacannes.com",43.5505,7.0168),
    v("Le Roof at Hotel Five Seas","Mediterranean Rooftop","Hotel Five Seas rooftop — panoramic Cannes views, refined gastronomy, chic cocktail lounge, one of the city's most beautiful hidden rooftop experiences with 360-degree Riviera vistas",4.6,f(false,false,true,false,false,false,false,false),"https://five-seas-hotel-cannes.com",43.5518,7.0093,"rooftop"),
    v("Mantel","French Contemporary","One Michelin star, Nicolas Decherchi's inventive Riviera cuisine, intimate and exceptional",4.8,f(true,false,true,false,false,false,true,true),"https://restaurantmantel.com",43.5501,7.0169),
    v("Mirazur","French Mediterranean","Three Michelin stars, Mauro Colagreco's Menton masterpiece — 20 min from Cannes, world's top 5",4.9,f(true,false,false,true,true,false,true,true),"https://mirazur.fr",43.7748,7.512),
    v("Sea Sens","French Riviera Rooftop","Rooftop restaurant at Five Seas Hotel, contemporary French cuisine with panoramic Cannes views",4.7,f(false,true,true,false,true,false,true,false),"https://five-seas-hotel-cannes.com/en/restaurant",43.5518,7.0093),
    v("Mauro Colagreco Beach Restaurant","Mediterranean Beach","The three-star chef's casual beach concept, sustainable seafood and Riviera flavors at the shore",4.7,f(false,true,true,false,true,false,true,false),"https://mirazur.fr",43.5519,7.0218),
    v("Table 22","French Contemporary","Chef Noël Mantel's second address, tasting menus in an intimate setting, new Cannes gem",4.7,f(false,true,true,false,false,false,true,true),"https://table22cannes.com",43.55,7.0161),
    v("Aux Bons Enfants","French Bistro","Cannes institution since 1935, cash only, legendary, beloved by locals",4.6,f(false,false,false,true,false,false,false,false),"https://auxbonsenfants.net",43.5496,7.0156),
    v("L'Oasis","French Riviera","Historical La Napoule restaurant, lobster and sea views, 15 min from Cannes",4.6,f(false,false,false,true,false,false,false,true),"https://oasis-raimbault.com",43.5165,6.9415),
    v("Zucca","Italian Riviera","Charming Italian trattoria beloved by locals and festival regulars, excellent pasta",4.6,f(false,false,false,true,true,false,false,false),"https://zucca-cannes.com",43.551,7.017),
    v("Le Park 45","Contemporary French","Grand Hotel's restaurant, Michelin-cited, Croisette views, tasting menus",4.6,f(false,false,true,false,true,false,true,true),"https://grand-hotel-cannes.com",43.5518,7.0093),
    v("La Mère Besson","Provençal","Classic Provençal bistro, hearty fish soup, one of Cannes' oldest restaurants",4.5,f(false,false,false,true,false,false,false,false),"https://lamerbesson.com",43.5493,7.0165),
    v("Le Comptoir des Vins","Wine Bar & Bistro","Outstanding wine selection, charcuterie and cheese, Le Suquet neighborhood gem",4.6,f(false,false,false,true,false,false,false,true),"https://lecomptoirdesvinscannes.com",43.55,7.0152),
    v("La Cave","Wine Bar","Best wine bar in Cannes, natural and local bottles, great atmosphere",4.5,f(false,false,true,false,false,false,false,true),"https://lacavecannes.com",43.55,7.0153,"bar"),
    v("3.14 Club Rooftop","Rooftop Bar","3.14 Hotel's stunning rooftop pool bar, panoramic Cannes and sea views, festival hotspot",4.6,f(false,false,true,false,true,false,false,false),"https://3-14hotel.com",43.549,7.0186,"rooftop"),
    v("Morrison's Irish Pub","Pub","The festival crowd's go-to late night pub, lively after-parties, live music",4.3,f(false,false,false,true,false,true,false,false),"https://morrisonspub.com",43.5495,7.0164,"bar"),
    v("Hôtel Barrière Le Majestic Bar","Hotel Bar","The Croisette's most glamorous hotel bar, perfect for festival season Champagne",4.6,f(false,false,false,true,true,false,false,false),"https://hotelsbarriere.com/fr/cannes/le-majestic",43.5504,7.0108,"bar"),
    v("Bar des Célébrités at Hotel Martinez","Hotel Bar","Legendary festival bar inside the iconic Art Deco Martinez, Champagne and cocktails",4.6,f(false,false,false,true,true,false,false,false),"https://hotel-martinez.hyatt.com",43.551,7.0199,"bar"),
    v("Kinugawa Cannes","Japanese","Chic Japanese from the acclaimed Paris brand, Riviera outpost",4.5,f(false,false,true,false,true,false,false,false,false,true),"https://kinugawa.fr",43.5508,7.016,"sushi"),
  
    // ── Coffee & Cafés ───────────────────────────────────────────────────
    v("Café Carlton","Grand Café","La Croisette — legendary Art Deco café terrace at the InterContinental Carlton, prime people-watching on the Croisette, perfect espresso, the classic Cannes coffee experience",4.6,f(false,false,false,true,true,false,false,false),"https://sofitel-legend-old-cataract.com",43.5512,7.0155,"coffee"),
    v("Café Roma","Local Favorite","Old Town — beloved Cannes institution in the Suquet old town, excellent espresso, morning croissants, authentic French café atmosphere away from tourist crowds",4.5,f(false,false,false,true,false,false,false,true),"https://caferoma-cannes.com",43.5497,7.0147,"coffee"),
    v("Coffee & Cot","Specialty Coffee","Central Cannes — Cannes's best specialty espresso bar, excellent single-origin beans, light and welcoming space, ideal for a Cannes film festival business coffee",4.6,f(false,false,true,false,false,false,false,true),"https://coffeecot.com",43.551,7.0174,"coffee"),
  ],
  ...
  "Milan": [
    ...
    v("Ceresio 7","Rooftop Bar","Design hotel rooftop pools and cocktails, Porta Garibaldi",4.6,f(false,false,true,false,true,false,false,false),"https://ceresio7.com",45.4789,9.1751,9.1811,"rooftop"),
    v("Iyo","Japanese Omakase","One Michelin star, Milan's best omakase, exceptional quality and sourcing",4.8,f(true,false,false,false,false,false,true,true,false,true),"https://iyo.it",45.4629,9.2021,9.1781,"sushi"),
    v("Osaka","Japanese","Milan's most beloved traditional Japanese restaurant",4.6,f(false,false,false,true,false,false,false,true,false,true),"https://osakaristorante.it",45.4659,9.1921,9.1891,"sushi"),
    ...
    // ── Coffee & Cafés ───────────────────────────────────────────────────
    v("Pasticceria Marchesi","Historic Pastry Café","Via Monte Napoleone — 1824 Milanese pastry institution acquired by Prada, magnificent historic interiors, impeccable espresso and pastries, most glamorous café in Milan",4.8,f(false,false,false,true,true,false,false,false),"https://pasticceriamarchesi.com",45.4669,9.1861,"coffee"),
    v("Caffè Cova","Historic Café","Via Monte Napoleone — 1817 Milanese café institution near Teatro alla Scala, beautiful belle époque interiors, panettone, the quintessential Milanese espresso experience",4.7,f(false,false,false,true,true,false,false,false),"https://caffecova.com",45.4669,9.1931,"coffee"),
  ...
  "Paris": [
    v("Guy Savoy","French","Three Michelin stars, best tasting menu in Paris",4.9,f(true,false,false,true,true,false,true,true),"https://guysavoy.com",36.116,-115.174),
    ...
    v("Septime","French Contemporary","One Michelin star, hottest table in Paris, Bastille — book 4 weeks ahead",4.8,f(true,false,true,false,true,false,true,true),"https://septime-charonne.fr",48.852,2.3788),
    ...
    v("Caviar Kaspia","Caviar & Champagne","Celebrity haunt atop Place de la Madeleine, midnight supper staple",4.7,f(false,false,false,true,true,false,false,true),"https://caviar-kaspia.com",48.87,2.3247),
    ...
    v("Frenchie","French Contemporary","One Michelin star, Rue du Nil, impossible to book",4.7,f(true,false,true,false,false,false,true,false),"https://frenchierestaurant.com",48.8651,2.3498),
    v("Le Châteaubriand","French Contemporary","Natural wine bistro pioneer, innovative and iconic",4.7,f(false,false,true,false,true,false,true,false),"https://lechateaubriand.net",48.8678,2.3788,2.3728),
    v("Le Grand Café at Grand Palais","French Brasserie","2025's most spectacular opening — Loulou Groupe restores the Grand Palais brasserie, stunning Belle Époque setting",4.8,f(false,true,true,false,true,false,true,false),"https://grandcafegrandpalais.fr",48.866,2.3118,2.3122),
    v("Billie","French Contemporary","Paris's beautiful people and their resident DJ — leather and marble, open till 2am, instant fashion crowd destination",4.7,f(false,true,true,false,true,true,true,false),"https://billieparis.com",48.8636,2.3548,2.3126),
    v("Casa Pregonda","Mediterranean","Fashion crowd's new HQ, Balearic-inspired, best sangria in Paris, stunning Marais setting",4.7,f(false,true,true,false,true,false,true,false),"https://casapregonda.com",48.8566,2.3498,2.3536),
    v("Verjus","French Wine Bar","Stunning natural wine cave and restaurant, Jackson Square of Paris — essential classics",4.8,f(false,false,true,false,true,false,true,true),"https://verjusparis.com",48.8627,2.3368,2.3376),
    v("Semilla","French Contemporary","Saint-Germain gem from the Verjus team, seasonal market menu, exceptional value",4.7,f(false,false,true,false,true,false,true,true),"https://semillaparis.com",48.8536,2.3418,2.3376),
    v("Au Passage","French Wine Bar","11th arrondissement natural wine bar and small plates, beloved by chefs",4.7,f(false,false,true,false,false,false,true,false),"https://restaurant-aupassage.fr",48.8578,2.3698,2.3658),
    v("Mokonuts","Middle Eastern French","Omar Koreitem and Moko Hirayama's cult bakery-restaurant, best cookies in Paris",4.7,f(false,true,false,false,false,false,true,false),"https://mokonuts.com",48.8548,2.3898,2.3728),
    v("Benoît","Classic French Bistro","Alain Ducasse's legendary Left Bank bistro, cassoulet and blanquette de veau, timeless",4.7,f(false,false,false,true,true,false,false,true),"https://benoit-paris.com",48.8596,2.3498,2.3476),
    v("David Toutain","French Contemporary","One Michelin star, inventive seasonal tasting menus, quiet and exceptional",4.8,f(true,false,false,false,false,false,true,true),"https://davidtoutain.com",48.8578,2.3148,2.3177),
    v("Hakuba","Japanese Omakase","Omakase at Cheval Blanc hotel — Paris's most rarefied sushi experience, extraordinary",4.8,f(true,false,false,false,true,false,true,true,false,true),"https://chevalblanc.com/paris",48.8573,2.3578,2.3476,"sushi"),
    v("Café de Flore","French Café","Saint-Germain café institution, Sartre and de Beauvoir",4.4,f(false,false,false,true,true,false,false,false),"https://cafedeflore.fr",48.854,2.3327),
    v("Harry's New York Bar","Cocktail Bar","Hemingway's Paris bar since 1911, Bloody Mary birthplace",4.5,f(false,false,false,true,true,false,false,false),"https://harrysbar.fr",48.8703,2.331,2.3296,"bar"),
    v("Prescription Cocktail Club","Cocktail Bar","Saint-Germain speakeasy, craft cocktails done right",4.6,f(false,false,true,false,true,false,false,false),"https://prescriptioncocktailclub.com",48.8536,2.3358,2.3376,"bar"),
    v("Candelaria","Cocktail Bar","Hidden taqueria with speakeasy cocktail bar behind",4.5,f(false,false,true,false,true,false,false,false),"https://quixotic-projects.com/venue/candelaria",48.8583,2.3588,2.3526,"bar"),
    v("Bar Nouveau","Cocktail Bar","#17 on World's 50 Best Bars — Paris's most acclaimed cocktail destination, extraordinary program",4.9,f(false,true,true,false,true,false,true,false),"https://barnouveau.fr",48.875,2.34,2.3526,"bar"),
    v("Cambridge Public House","Cocktail Bar","#20 World's 50 Best Bars — beloved Parisian pub-meets-cocktail bar, outstanding drinks",4.8,f(false,true,true,false,true,false,false,false),"https://cambridgepub.fr",48.866,2.3808,2.3468,"bar"),
    v("Danico","Cocktail Bar","#30 World's 50 Best Bars — hidden bar inside a wine shop, extraordinary cocktails",4.8,f(false,true,true,false,true,false,true,false),"https://danico.fr",48.862,2.3458,2.3438,"bar"),
    v("Little Red Door","Cocktail Bar","Conceptual cocktail bar, seasonal ingredient-driven menu, Marais institution",4.7,f(false,false,true,false,true,false,true,false),"https://lrdparis.com",48.8543,2.3528,2.3526,"bar"),
    v("Experimental Cocktail Club","Cocktail Bar","The OG Paris craft cocktail pioneer, intimate and excellent, Marais",4.7,f(false,false,true,false,true,false,false,false),"https://experimentalcocktailclub.com",48.8543,2.3528,2.3486,"bar"),
    v("Le Perchoir","Rooftop Bar","Paris's most beloved rooftop bar, Oberkampf panoramic views, always packed",4.6,f(false,false,true,false,true,false,true,false),"https://leperchoir.fr",48.8608,2.3828,2.3768,"rooftop"),
    v("Bisou Canal","Bar","Canal Saint-Martin's best bar, laid-back natural wine and cocktails, local crowd",4.6,f(false,false,true,false,false,false,false,false),"https://bisoucanal.com",48.8698,2.3618,2.3648,"bar"),
    v("Bristol After Dark","Hotel Bar","Le Bristol's legendary late-night bar, old-money Paris glamour, serious cocktails",4.7,f(false,false,false,true,true,false,false,true),"https://lebristolparis.com",48.8728,2.3098,2.3136,"bar"),
    v("Sushi Yoshitake","Japanese Omakase","Three Michelin stars in Tokyo; the Paris outpost maintains extraordinary standards",4.8,f(true,false,false,false,false,false,true,true,false,true),"https://sushi-yoshitake.com",48.8708,2.3158,2.3296,"sushi"),
    v("Akami","Japanese Omakase","One Michelin star, outstanding omakase in the Marais, exceptional fish",4.8,f(true,false,true,false,false,false,true,true,false,true),"https://akami.fr",48.8788,2.3198,2.3556,"sushi"),
    v("Isami","Japanese","Paris's most celebrated traditional sushi, Île Saint-Louis institution",4.7,f(false,false,false,true,false,false,true,true,false,true),"https://isami-paris.com",48.8519,2.3558,2.3536,"sushi"),
    v("Matsuhisa Paris","Japanese-Peruvian","Chef Nobu Matsuhisa's only restaurant in France — inside Le Royal Monceau–Raffles Paris, black cod miso, wagyu tobanyaki, yellowtail jalapeño, celebrating 10 years in 2026, the Matsuhisa brand's most elevated outpost",4.7,f(false,false,true,false,true,false,true,true,false,true),"https://raffles.com/paris/dining/matsuhisa-paris",48.8768,2.3013,"sushi"),
  
    // ── Coffee & Cafés ───────────────────────────────────────────────────
    v("Café de Flore","Iconic Café","Saint-Germain — 1887 literary institution, Sartre and Simone de Beauvoir's table, perfect café crème, the most famous café in the world",4.7,f(false,false,false,true,true,false,false,false),"https://cafedeflore.fr",48.854,2.3327,"coffee"),
    v("Télescope","Specialty Coffee","1st Arrondissement — Paris specialty coffee pioneer, exceptional single-origin espresso, tiny and beautiful near the Palais Royal, great for a Right Bank meeting",4.7,f(false,false,true,false,false,false,false,true),"https://telescopecafe.com",48.8627,2.3408,2.3386,"coffee"),
    v("Coutume Café","Specialty Roaster","Saint-Germain — Australian influence on Paris coffee, exceptional beans, beautiful Saint-Germain space, light and airy, ideal for a Left Bank business meeting",4.7,f(false,false,true,false,false,false,false,true),"https://coutumecafe.com",48.8536,2.3268,2.3230,"coffee"),
    v("Café de la Paix","Grand Café","Opera — 1862 Haussmann-era grand café at the Grand Hotel, gilded interiors, impeccable service, one of Paris's most opulent café experiences",4.6,f(false,false,false,true,true,false,false,false),"https://cafedelapaix.fr",48.8717,2.3325,"coffee"),
    v("Fragments","Specialty Coffee","Marais — acclaimed Marais specialty café, excellent roasters, minimalist design, quiet and excellent for a Marais business coffee",4.6,f(false,false,true,false,false,false,false,true),"https://fragmentscafe.fr",48.8593,2.3598,2.3508,"coffee"),
    v("Boot Café","Tiny Gem","Marais — 10-seat café inside a tiny former cobbler's shop in the Marais, excellent espresso, standing-room-only queues, most charming café in Paris",4.7,f(false,true,true,false,false,false,false,false),"https://bootcafe.com",48.8593,2.3588,2.3508,"coffee"),
    v("Ten Belles","Specialty Coffee","Canal Saint-Martin — pioneer of Paris specialty coffee, excellent beans and brewing, beautiful Canal setting, great for a cool-Paris meeting",4.7,f(false,false,true,false,false,false,false,true),"https://tenbelles.com",48.8688,2.3648,2.3622,"coffee"),
    v("Café Kitsuné","Fashion Café","Palais Royal — Maison Kitsuné's iconic café in the Palais Royal gardens, matcha latte, fox cookies, fashion crowd, one of the most stylish café settings in the world",4.7,f(false,false,true,false,true,false,false,false),"https://kitsune.fr/pages/cafes",48.8637,2.3378,2.3369,"coffee"),
  ],
  ...
  "Mykonos": [
    ...
    v("Obati","Greek Contemporary","Chora's newest modern Greek taverna, wood-fired whole fish and Cycladic flavors",4.7,f(false,true,false,false,false,false,true,true),"https://obatimykonos.com",37.4462,25.3285,25.3293),
    v("Interni","Mediterranean","Romantic garden setting in Mykonos Town, consistently excellent",4.6,f(false,false,false,true,true,false,false,true),"https://internirestaurant.com",37.4454,25.3293),
    v("Fokos Taverna","Greek","Remote beach taverna, traditional and magical, no menus — just whatever the boat brought in",4.7,f(false,false,false,true,false,false,false,true),"https://fokostaveran.gr",37.475,25.31,25.3551),
    v("Katrin","Greek","Old Town institution since 1969, traditional and beloved by every Mykonos local",4.5,f(false,false,false,true,false,false,false,true),"https://katrinmykonos.gr",37.4455,25.3285),
    v("Galleraki","Cocktail Bar","Little Venice's most beautiful cocktail bar, waves crashing beneath, sunset institution",4.7,f(false,false,true,false,true,false,false,false),"https://gallerakimykonos.com",37.4462,25.3258,25.3274,"bar"),
    v("Remezzo","Cocktail Bar","Iconic Little Venice waterfront bar, legendary sunsets, classic Mykonos",4.5,f(false,false,false,true,true,false,false,false),"https://remezzomykonos.com",37.446,25.3255,25.3274,"bar"),
    v("180° Sunset Bar","Rooftop Bar","Panoramic 180-degree views over the Aegean, DJ sets at sunset, spectacular",4.7,f(false,false,true,false,true,false,false,false),"https://180mykonos.com",37.4462,25.3252,25.3264,"rooftop"),
    v("Cavo Paradiso","Nightclub","Mykonos's legendary clifftop nightclub, world-class DJs, open-air and iconic",4.6,f(false,false,true,false,true,true,false,false),"https://cavoparadiso.gr",37.485,25.365,25.3311,"bar"),
    v("Pierro's","Bar","The original Mykonos nightlife institution since 1976, the after-hours destination",4.4,f(false,false,true,false,true,true,false,false),"https://pierrosmykonos.gr",37.4462,25.3275,25.3283,"bar"),
    v("Babylon","Bar","Little Venice gay bar, legendary sunset cocktails, Mykonos classic",4.3,f(false,false,true,false,true,false,false,false),"https://babylonmykonos.gr",37.446,25.326,25.3264,"bar"),
    ...
    v("Zuma Mykonos","Japanese Robatayaki","Seasonal Zuma outpost at Santa Marina, stunning robatayaki",4.6,f(false,false,true,false,true,false,true,false,false,true),"https://zumarestaurant.com/zuma-mykonos",37.455,25.37,25.3443,"sushi"),
  ...
  "Martha's Vineyard": [
    ...
    v("Outermost Inn","American Seasonal","Aquinnah, sweeping ocean views, Gay Head Light. Hyper-seasonal menu, brunch with large-format cocktails",4.7,f(false,false,false,true,false,false,false,true),"https://outermostinn.com",41.348,-70.8385),
