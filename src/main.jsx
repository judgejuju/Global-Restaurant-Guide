...
const INITIAL_DATA = {
  ...
  "LA/WeHo": [
    ...
    v("Somni","Spanish Contemporary","Three Michelin stars in 2025 — WeHo's most transcendent experience, Chef Aitor Zabala, 14-seat chef's counter, $495pp, modernist Catalan tasting menu, shiso tempura tartare, mandatory beverage pairing, 'dream' in Catalan",4.9,f(true,true,false,false,true,false,true,true),"https://somnila.com",34.0736,-118.4004),
    v("Providence","Seafood","Two Michelin stars — Michael Cimarusti's temple to the sea, LA's finest seafood dining",4.9,f(true,false,false,true,true,false,true,true),"https://providencela.com",34.0833,-118.3418),
    v("n/naka","Japanese Kaiseki","Two Michelin stars — Niki Nakayama's kaiseki masterpiece, 13 courses, near-impossible reservation",4.9,f(true,false,false,false,false,false,true,true),"https://n-naka.com",34.0195,-118.3542),
    v("Vespertine","Avant-garde","One Michelin star — Jordan Kahn's otherworldly sci-fi dining experience in Culver City",4.8,f(true,false,true,false,true,false,true,true),"https://vespertine.la",34.0093,-118.3951),
    v("Gucci Osteria","Italian","One Michelin star — Massimo Bottura's Beverly Hills outpost, seasonal Italian, a pilgrimage for food lovers",4.6,f(true,false,true,false,true,false,true,false),"https://gucciosteria.com/beverly-hills",34.0736,-118.3960),
    v("Ardor","California Vegetable","MICHELIN Selected, The West Hollywood EDITION — Chef John Fraser, vegetables take center stage, grilled branzino, tropical-chic Architectural Digest interiors",4.7,f(false,false,true,false,true,false,true,false),"https://ardorla.com",34.0917,-118.3820),
    v("Sushi Ginza Onodera","Japanese Omakase","One Michelin star — Beverly Hills omakase, fish flown directly from Ginza Tokyo fish markets",4.8,f(true,false,false,false,false,false,true,true,false,true),"https://losangeles.sushiginzaonodera.com",34.0736,-118.3990,"sushi"),
    // ── West Hollywood — New 2025 ─────────────────────────────────────────
    v("Sushisamba West Hollywood","Japanese-Brazilian-Peruvian","March 2026 flagship opening — 11,000 sq ft $20M rooftop next to Kimpton La Peer, retractable dome, old Hollywood glamour by Dizon Collective, robata bar, shiso caipirinhas, crispy tuna rice, private dining room with its own elevator",4.7,f(false,true,true,false,true,false,false,false),"https://sushisamba.com/locations/west-hollywood",34.0927,-118.3840,"rooftop"),
    v("Darling","Live-Fire American","Chef Sean Brock (Husk) comes to WeHo — citrus, oak and almond wood fire cookery, California coastal ingredients, hi-fi vinyl listening lounge on the patio, one of the most anticipated 2025 openings",4.7,f(false,true,true,false,true,true,true,false),"https://darlingweho.com",34.0927,-118.3840),
    v("Ladyhawk","Eastern Mediterranean","Kimpton La Peer — Top Chef's Charbel Hayek, octopus with chorizo butter, olive-crusted rack of lamb, hummus and garlic labneh with pillowy pita, best new social table in WeHo",4.6,f(false,true,true,false,true,false,true,false),"https://ladyhawkla.com",34.0917,-118.3820),
    v("Marea Beverly Hills","Italian Seafood","NYC's legendary seafood temple lands in Beverly Hills (Jan 2025) — bone marrow fusilli, Dungeness crab pappardelle, onyx bar, blue Murano chandelier, Sophia Loren portrait, instant power lunch",4.7,f(false,true,true,false,true,false,true,true),"https://marearestaurant.com/beverly-hills",34.0736,-118.3980),
    v("Monsieur Dior by Dominique Crenn","French","Three Michelin star chef Dominique Crenn's first restaurant outside Paris — atop House of Dior Beverly Hills, caviar service, Black Truffle Agnolotti, Guinea Hen Rodeo, designed by Peter Marino",4.8,f(true,true,false,false,true,false,true,true),"https://dior.com/restaurant",34.0736,-118.3980),
    v("Andys","New American","Anderson .Paak's retro 1970s lounge — live music and vinyl DJ sets, New American small plates with Asian twist, bottle service tables, occasional celebrity appearances by the owner himself",4.5,f(false,true,true,false,true,true,false,false),"https://andysweho.com",34.0917,-118.3820,"bar"),
    v("Marvito","Tex-Mex Cantina","WeHo's latest late-night crusader, open until midnight — queso dip with chorizo, crispy beef tacos, chicken piccata, La Picosa Old Fashioned, fun rowdy group dinner energy",4.5,f(false,true,true,false,false,false,false,false),"https://marvito.la",34.0917,-118.3820),
    v("Coucou","French Bistro","Venice's celebrated French bistro comes to WeHo — Apero Hour at the marble bar 5–6pm, steak frites, chicken paillard, relaxed and refined with coastal California produce",4.6,f(false,false,true,false,true,false,false,false),"https://coucourestaurant.com",34.0917,-118.3820),
    // ── West Hollywood — Established Icons ───────────────────────────────
    v("Merois","Asian Fusion Rooftop","Wolfgang Puck's rooftop atop Pendry West Hollywood — sweeping LA skyline views, hamachi tostada with yuzu kosho, scallop pad thai, crab fried rice, Japanese milk bread with coconut kaya, the city's most glamorous dinner view",4.7,f(false,false,true,false,true,false,true,false),"https://meroisweho.com",34.0927,-118.3820,"rooftop"),
    v("Catch LA","Seafood Rooftop","WeHo rooftop celebrity dining — always packed with industry, the classic LA scene experience",4.4,f(false,false,true,false,true,false,false,false),"https://catchrestaurants.com/location/la",34.0917,-118.3750,"rooftop"),
    v("Craig's","American","Melrose Avenue celebrity institution — George Clooney, Ozzy Osbourne, John Legend regulars, honey truffle chicken, old Hollywood charm, paparazzi outside on weekends",4.5,f(false,false,false,true,true,false,false,false),"https://craigsla.com",34.0855,-118.3730),
    v("Cecconi's West Hollywood","Italian","Design District Italian icon — wood-oven pizzas, fresh pastas, Soho House sister, always a chic scene",4.5,f(false,false,true,false,true,false,false,false),"https://cecconis.com/west-hollywood",34.0855,-118.3760),
    v("Night + Market WeHo","Thai","Kris Yenbamroong's Thai institution on Sunset Strip — great food, great wine, always feels like a party, the casual WeHo spot that everyone loves",4.6,f(false,false,true,false,true,false,false,false),"https://nightandmarketweho.com",34.0917,-118.3770),
    v("Horses","American Bistro","Coolest room in LA — natural wine, perpetually buzzy, East Hollywood neighborhood gem",4.7,f(false,true,true,false,true,false,true,false),"https://horsesla.com",34.0903,-118.3690),
    v("Dan Tana's","Italian","Sunset Strip institution since 1964 — red-leather booths, checkered tablecloths, George Clooney and Brad Pitt since forever, cozy yellow bungalow, the OG Hollywood Italian",4.5,f(false,false,false,true,true,false,false,false),"https://dantanasrestaurant.com",34.0917,-118.3820),
    v("Delilah","Supper Club","WeHo's sexiest supper club — no photos allowed, Drake/Kendall/Biebers spotted regularly, vintage-inspired, prohibition cocktails, celebrity party central",4.5,f(false,true,false,true,true,true,false,false),"https://delilahla.com",34.0855,-118.3730,"bar"),
    v("Tower Bar at Sunset Tower Hotel","Hotel Bar","Sunset Strip's most storied hotel bar — Art Deco 1929 building, Marilyn Monroe, Jean Harlow, Sinatra all lived here, stresses-out agents, Olsen twins, enraged agents — legendary scene",4.5,f(false,false,false,true,true,false,false,true),"https://sunsettowerhotel.com",34.0927,-118.3870,"bar"),
    v("Skybar at Mondrian","Rooftop Pool Bar","Rande Gerber's iconic 1996 pool bar — A-list party history, ivy-covered open-air pavilion, world-class DJs, best views of WeHo",4.4,f(false,false,true,false,true,true,false,false),"https://sbe.com/nightlife/skybar",34.0917,-118.3870,"rooftop"),
    v("Employees Only WeHo","Cocktail Bar","Prohibition-style cocktails next to Delilah — head here after dinner for the perfect nightcap",4.5,f(false,false,true,false,true,false,false,false),"https://employeesonlyla.com",34.0855,-118.3730,"bar"),
    // ── LA Classics & Broader ─────────────────────────────────────────────
    v("Baldi at Waldorf Astoria","Tuscan Steakhouse","Edoardo Baldi's Beverly Hills debut (2025) — olive-wood fired steaks, spectacular room at Waldorf Astoria",4.8,f(false,true,true,false,true,false,true,true),"https://baldibeverlyhills.com",34.0736,-118.3980),
    v("Bestia","Italian","Arts District anchor — wood-fired and perpetually buzzy, charcuterie, house-made pastas",4.7,f(false,false,true,false,true,false,true,false),"https://bestiala.com",34.0411,-118.2327),
    v("Mother Wolf","Italian","Evan Funke's Rome-inspired pasta palace in Hollywood — hand-pulled cacio e pepe at the marble bar",4.5,f(false,true,true,false,true,false,true,false),"https://motherwolfla.com",34.1016,-118.3278),
    v("Jon & Vinny's","Italian-American","Best pasta in LA — always packed, Silver Lake staple, great Calabrian chili pizza",4.7,f(false,false,true,false,true,false,true,false),"https://jonandvinnys.com",34.0831,-118.2707),
    v("Spago","California","Wolfgang Puck's legendary Beverly Hills institution — smoked salmon pizza, power lunch, always outstanding",4.6,f(false,false,false,true,true,false,false,true),"https://wolfgangpuck.com/dining/spago-beverly-hills",34.0736,-118.3980),
    v("The Polo Lounge","American","Beverly Hills Hotel institution — power breakfast legends, Henry Fonda and Katharine Hepburn corner booths",4.5,f(false,false,false,true,true,false,false,false),"https://beverlyhillshotel.com/dining/polo-lounge",34.0790,-118.4134),
    v("Gjusta","Bakery/Deli","Venice institution — perpetual lines, celebrity hangout, best bread and tinned fish in LA",4.6,f(false,false,false,true,true,false,false,false),"https://gjusta.com",33.9901,-118.4710),
    v("Bar Marmont","Cocktail Bar","Chateau Marmont's eternal celebrity haunt — the most reliable celebrity sighting in LA, always on",4.4,f(false,false,false,true,true,false,false,false),"https://chateaumarmont.com",34.0927,-118.3820,"bar"),
    v("Musso & Frank Grill","American","Hollywood's oldest restaurant since 1919 — Sinatra, Monroe, Garbo, Brando all dined here, the flannel shirt and martini crowd",4.4,f(false,false,false,true,true,false,false,false),"https://mussoandfrank.com",34.1013,-118.3280),
    v("The Jonathan Club","Private Members Club","LA's most prestigious private club — Downtown and Beach locations",4.7,f(false,false,false,true,true,false,true,true,true),"https://jc.org",34.0490,-118.2520,"private club"),
    v("Soho House West Hollywood","Private Members Club","The creative industry's living room — film, fashion, music, art, rooftop pool",4.5,f(false,false,true,false,true,false,false,false,true),"https://sohohouse.com/houses/soho-house-west-hollywood",34.0855,-118.3730,"private club"),
    // ── Sushi ─────────────────────────────────────────────────────────────
    v("Sushi Park","Japanese Omakase","Hidden rooftop omakase on Sunset Strip — Taylor Swift, Beyoncé, the Kardashians all keep it secret, no salad/no tempura/no 'trendy sushi' sign at the door, pure outstanding quality",4.7,f(false,false,false,true,true,false,true,false,false,true),"https://sushiparkla.com",34.0917,-118.3770,"sushi"),
    v("Nobu Malibu","Japanese-Peruvian","Oceanfront Nobu on PCH — celebrity central, stunning Malibu setting, sashimi tacos",4.6,f(false,false,true,false,true,false,false,false,false,true),"https://noburestaurants.com/malibu",34.0195,-118.6789,"sushi"),
    v("Sushi Zo","Japanese Omakase","Pure omakase experience — beautifully fresh fish, artful preparation, West LA institution",4.7,f(false,false,false,true,false,false,true,true,false,true),"https://sushizo.us",34.0195,-118.4912,"sushi"),
  ],
