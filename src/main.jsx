...
const INITIAL_DATA = {
  ...
  "Santa Monica": [
    ...
    v("Houston's","American","Part of the legendary Hillstone group, now called Hillstone SM — LA power dining institution, kale salad, French dip and ribs that haunt David Chang, Taylor Swift sighting spot",4.6,f(false,false,false,true,true,false,false,false),"https://hillstonerestaurant.com/locations/santamonica",34.0178,-118.4914),
