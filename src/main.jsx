...
const INITIAL_DATA = {
  ...
  "Cannes": [
    v("La Palme d'Or","French Mediterranean","1 Michelin Star — Hotel Martinez's legendary restaurant, host of the annual Cannes Jury Dinner, Chef Jean Imbert's cinematically immersive room designed like a vintage boat, menu styled as a film script, panoramic Croisette bay terrace",4.9,f(true,false,true,false,true,false,true,true),"https://hotel-martinez.hyatt.com",43.5490,7.0186),
    ...
    v("La Môme","French Riviera Bistro","Steps from the Croisette — La Dolce Vita spirit, Slim Aarons photography, crudo towers, egg yolk ravioli, snacked octopus, wagyu tomahawk, the festival season celebrity magnet from brunch to late night",4.7,f(false,true,true,false,true,false,false,false),"https://lamome-cannes.com",43.5504,7.0174),
    v("Rüya at Carlton Cannes","Turkish Anatolian","Inside the iconic Carlton Cannes — only Anatolian restaurant on the Croisette, seven regions of Turkey in shared plates, charcoal-grilled King prawns, 24-hour Wagyu brisket, wood-fired pide, a genuine break from typical Riviera fare",4.7,f(false,true,true,false,true,false,false,false),"https://ruyarestaurant.co.uk/cannes",43.5510,7.0175),
    v("La Guérite","Mediterranean Beach Club","Accessible only by boat to Île Sainte-Marguerite — Cannes' most glamorous lunch, Greek-inspired cuisine by Chef Yiannis Kioroglou, crystalline water setting, the ultimate film festival celebrity hideaway",4.8,f(false,false,true,false,true,false,true,false),"https://laguerie.com",43.5200,7.0550),
    v("Baoli Beach","Asian-French Fusion","Port Canto — Chef Rémi Solaz's Asian-inspired cuisine, Cloud Nine rooftop for sunset cocktails, transforms into Cannes' most electric nightclub by midnight, essential festival circuit destination, open March to October",4.6,f(false,false,true,false,true,true,false,false),"https://baolicannes.com",43.5440,7.0313),
    v("La Petite Maison Cannes","French Provençal","Palm Beach — Riviera classic by Nicole Rubi, truffle scrambled eggs, pissaladière, Cap d'Antibes views, the Nice institution that launched a global empire from London to Dubai, everyone treated like a film star",4.7,f(false,false,true,false,true,false,false,false),"https://lpminternational.com/cannes",43.5394,7.0428),
    v("Zuma Cannes","Japanese Robatayaki","Palm Beach — opened May 2024, the global brand's most glamorous Riviera outpost, massive terrace over the Côte d'Azur, live DJs, sushi and robata tableside theatre, the hottest Japanese restaurant on the French Riviera",4.7,f(false,true,true,false,true,true,false,false),"https://zumarestaurant.com/cannes",43.5394,7.0428,"sushi"),
    v("La Plage du Martinez","Mediterranean Beach","Hotel Martinez private beach — Chef Jean Imbert's relaxed seafront restaurant, Mediterranean fare, sunbed service, the Croisette's most coveted lunch reservation during film festival week",4.7,f(false,false,true,false,true,false,false,false),"https://hotel-martinez.hyatt.com",43.5490,7.0186),
    v("Anna Cannes","Modern Greek","Boulevard de la Croisette — Athenian-born Chef Yiannis Kioroglou, terrazzo floors evoking beach pebbles, blue-and-white ceiling, grilled octopus, fresh mezze, vibrant nighttime energy, the Croisette's most exciting Greek import",4.6,f(false,true,true,false,true,false,false,false),"https://anna-restaurant.fr",43.5510,7.0175),
    v("Salama","Moroccan Mediterranean","Rue Florian — sibling to the legendary Saint-Tropez Salama, spiced pastilla, harira, inventive cocktails, candlelit and dramatic, a favourite celebrity hideaway off the Croisette",4.6,f(false,false,true,false,true,false,false,false),"https://salamacannes.com",43.5504,7.0166),
